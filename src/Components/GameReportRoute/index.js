...
class GameReportRoute extends Component {
  ...
  onAllAttempted = () => {
    ...
    let wrongAnswers = attempted - rightAnswers
    let countUnattempted = 10 - attempted
    return (
          ...
          <div className='score-rectangle'>
            ...
            <div className='sub-div'>
              <img
                ...
                className='img'
              />
              <p className='para'>{wrongAnswers} Wrong answers</p>
            </div>
            <div className='sub-div'>
              <img
                ...
                className='img'
              />
              <p className='para'>{countUnattempted} Unattempted</p>
            </div>
          </div>
        </div>
