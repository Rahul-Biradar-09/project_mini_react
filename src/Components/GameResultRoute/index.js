    ...
    return (
      ...
      >
        <img
          ...
          alt={rightAnswers > 5 ? 'congrats' : 'lose'}
          className={rightAnswers > 5 ? 'trophy-image' : 'lose-image'}
        />
        <h1
          className={
            rightAnswers > 5
        ...
        >
          {rightAnswers > 5 ? 'Congrats!' : 'You lose!'}
        </h1>
        <h1 className="game-result-heading-2">
          {rightAnswers > 5 ? `${rightAnswers * 10}%` : `${rightAnswers * 10}%`}{' '}
          Correctly Answered
        </h1>
        {rightAnswers > 5 ? (
        ...
        <p
          className={
            rightAnswers > 5 ? 'game-result-para-2' : 'game-result-lose-para-1'
          }
        >
